...
model.testbed._set_evaluationRun("true")
...
router_edges = [["router1","router2"],["router1","router3"],["router2","router3"]]
...
host_edges = [["router1","pc1"],["router2","pc2"],["router3","pc3"],["router3","pc4"]]
