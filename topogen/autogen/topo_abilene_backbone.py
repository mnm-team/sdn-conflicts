...
for i in range(1,12):
  edges.append(["router{}".format(i),"pc{}".format(i)])

edges += [["router1","router2"],["router1","router3"],["router1","router4"],["router2","router3"],["router3","router5"],["router4","router6"],["router5","router6"],["router5","router7"],["router6","router8"],["router7","router9"],["router7","router8"],["router8","router11"],["router9","router10"],["router10","router11"]]

# make sure that no switches or hosts have the wrong format and add them to the topo
switches = set()
pc_sources = [2,4,6,8,10] # set pcs as sources
for e in edges:
  if "pc" not in e[0]:
    switches.add(e[0])
  else:
