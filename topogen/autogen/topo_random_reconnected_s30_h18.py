...
topoName = "random_reconnected_s30_h18"
...
###### Topology definition ######
# add switches
agraph = random_topo.get_large_reconnected_graph(10) # arg is seed
...
edges.append(["router25","pc1"])
edges.append(["router25","pc2"])
edges.append(["router18","pc3"])
edges.append(["router29","pc4"])
edges.append(["router29","pc5"])
edges.append(["router10","pc6"])
edges.append(["router27","pc7"])
edges.append(["router11","pc8"])
edges.append(["router26","pc9"])
edges.append(["router20","pc10"])
edges.append(["router20","pc11"])
edges.append(["router21","pc12"])
edges.append(["router23","pc13"])
edges.append(["router23","pc14"])
edges.append(["router28","pc15"])
edges.append(["router13","pc16"])
edges.append(["router13","pc17"])
edges.append(["router30","pc18"])

# make sure that no switches or hosts have the wrong format and add them to the topo
switches = set()
pc_sources = [18,3,6,7,10,11] # set pcs as sources
for e in edges:
  if "pc" not in e[0]:
    switches.add(e[0])
  else:
