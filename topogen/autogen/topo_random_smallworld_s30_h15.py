...
topoName = "random_smallworld_s30_h15"
...
###### Topology definition ######
# add switches
agraph = random_topo.get_large_smallworld_graph(10) # arg is seed
...
edges.append(["router13","pc1"])
edges.append(["router13","pc2"])
edges.append(["router11","pc3"])
edges.append(["router29","pc4"])
edges.append(["router30","pc5"])
edges.append(["router2","pc6"])
edges.append(["router2","pc7"])
edges.append(["router4","pc8"])
edges.append(["router5","pc9"])
edges.append(["router6","pc10"])
edges.append(["router8","pc11"])
edges.append(["router17","pc12"])
edges.append(["router19","pc13"])
edges.append(["router20","pc14"])
edges.append(["router23","pc15"])

# make sure that no switches or hosts have the wrong format and add them to the topo
switches = set()
pc_sources = [4,5,8,13,14,15] # set pcs as sources
for e in edges:
  if "pc" not in e[0]:
    switches.add(e[0])
  else:
