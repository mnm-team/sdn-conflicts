...
topoId = "back_bone_standford_pisharody_multi_transform_run_01" 
...
appAssetsConfig2.majorAsset.assetValue = "pc7"
appAssetsConfig2.minorAssets.assetKey = "servers"
appAssetsConfig2.minorAssets.assetItems = ["pc7","pc8"]

# host shadower
hs = model.testbed.apps.add("hs")
hs.config.cookie = "0x440"
hs.config.targetSwitches.add("router19")
hs.config.targetSwitches.add("router20")
...
source_hosts = [1] #,11,12,8,9,13,14,16,20] #,7,16,14,19]
...
edges = [["router1","router2"],["router1","router3"],["router1","router4"],["router1","router5"],["router1","router6"],["router1","router7"],["router1","router19"],["router2","router8"],["router2","router9"],["router2","router10"],["router2","router11"],["router2","router12"],["router2","router19"],["router3","router13"],["router3","router26"],["router4","router14"],["router4","router25"],["router5","router15"],["router5","router24"],["router6","router16"],["router6","router23"],["router6","router20"],["router7","router17"],["router7","router18"],["router7","router21"],["router7","router22"],["router8","router17"],["router8","router18"],["router8","router21"],["router8","router22"],["router9","router16"],["router9","router20"],["router9","router23"],["router10","router15"],["router10","router24"],["router11","router14"],["router11","router25"],["router12","router13"],["router12","router26"],["router13","router18"],["router13","pc1"],["router14","router17"],["router14","pc2"],["router15","router16"],["router15","pc3"],["router16","pc4"],["router17","pc5"],["router18","pc6"],["router19","router20"],["router19","pc7"],["router20","pc8"],["router21","router26"],["router21","pc9"],["router22","router25"],["router22","pc10"],["router23","router24"],["router23","pc11"],["router24","pc12"],["router25","pc13"],["router26","pc14"]]
