...
class FirewallController(ControllerBase):
    ...
    def regist_ofs(dp):
        ...
        FirewallController._LOGGER.info('dpid=%s: discovered by rest firewall.',
                                        dpid_str)
    ...
    def unregist_ofs(dp):
        if dp.id in FirewallController._OFS_LIST:
            ...
            FirewallController._LOGGER.info('dpid=%s: Leave rest firewall.',
...
# also need rest topology but not changes necessary
